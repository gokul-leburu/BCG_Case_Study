...
log_process = Log_process(2)

# COMMAND ----------

# Example usage
log_process = Log_process(2)
#display(log_process.log_table)
# Get a new batch ID
batch_id = log_process.get_new_batch_id("vehicle_crash")
print(batch_id)
# # Log the start of a process
# log_process.log_status("stage_1", "vehicle_crash", "analysis_1", batch_id, "started")

# # Log the completion of a process
# log_process.log_status("stage_1", "vehicle_crash", "analysis_1", batch_id, "completed")

# # Log a failure in a process
# log_process.log_status("stage_1", "vehicle_crash", "analysis_1", batch_id, "failed", "Error message")

# COMMAND ----------

# Log the start of a process
log_process.log_status("stage_2", "vehicle_crash", "analysis_2", batch_id, "started")

# Log the completion of a process
log_process.log_status("stage_2", "vehicle_crash", "analysis_2", batch_id, "completed")
